...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "anoochit-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/redlinesoft"
  #   chef.validation_client_name = "redlinesoft-validator"
  #   chef.validation_key_path = ".chef/redlinesoft-validator.pem"
  # end
end
